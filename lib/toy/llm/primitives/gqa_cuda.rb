# lib/toy/llm/primitives/gqa_cuda.rb — CUDA mirror of lib/toy/llm/primitives/gqa.rb.
#
...
# TinyNNCuda. -> TinyNNCuda<Backend>. rename handles the rest).
    ...
    module Primitives
      module GQA
        ...
        def self.attention(sess, t_k, t_q, t_vt, attn_mask, scale, batch)
          ...
          if batch > 1
            t_attn = TinyNNCuda.tnn_soft_max_ext(sess, t_scores, attn_mask, scale, 0.0)
          else
          ...
          TinyNNCuda.tnn_matmul(sess, t_vt, t_attn)
        end
      end
    end
  end
