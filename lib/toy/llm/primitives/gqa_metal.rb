# lib/toy/llm/primitives/gqa_metal.rb — Metal mirror of lib/toy/llm/primitives/gqa.rb.
#
    ...
    module Primitives
      module GQA
        ...
        def self.attention(sess, t_k, t_q, t_vt, attn_mask, scale, batch)
          ...
          if batch > 1
            t_attn = TinyNNMetal.tnn_soft_max_ext(sess, t_scores, attn_mask, scale, 0.0)
          else
          ...
          TinyNNMetal.tnn_matmul(sess, t_vt, t_attn)
        end
      end
    end
  end
