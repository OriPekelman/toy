# lib/toy/llm/primitives/rope_metal.rb — Metal mirror of lib/toy/llm/primitives/rope.rb.
#
...
# TinyNNMetal before requiring this primitive. Keeping the require out lets
...
# and that mirror's TinyNNMetal. -> TinyNNMetal<Backend>. rename handles the rest).
    ...
    module Primitives
      module RoPE
        ...
        def self.apply_2d(sess, t_pre, positions, freq_factors, cfg, t_seq, t_batch)
          tb = t_seq * t_batch
          t_pre3 = TinyNNMetal.tnn_reshape_3d(sess, t_pre, cfg.d_head, 1, tb)
          t3     = TinyNNMetal.tnn_rope_ext(sess, t_pre3, positions,
                                       cfg.d_head, cfg.base,
                                       cfg.freq_scale, cfg.ext_factor,
                                       cfg.attn_factor, cfg.beta_fast,
                                       cfg.beta_slow, freq_factors)
          TinyNNMetal.tnn_reshape_2d(sess, t3, cfg.d_head, tb)
        end
      end
    end
  end
