      ...
      module TrainFrankenMoe
        ...
        def self.run_cli
          ...
          while nmi < nev
            ...
            if eglu_count > 0
              TinyNN.tnn_tensor_set_name(tw.pp[eglu_base + nmi], "moe.expert_" + nmi.to_s + ".glu")
            end
            nmi = nmi + 1
          end
          if attn_gate
          ...
          b_blk = TinyNN.tnn_input_2d_f32_persistent(sess, dmv, vocabv)
          ...
          if block_dfa
            ...
            TinyNN.tnn_upload_from_float_array(sess, b_blk,
          ...
          if top1
            ...
            delta = TinyNN.tnn_matmul(sess, b_blk, e_det)          # [dm, T]
            t_blk = full_sum(sess, TinyNN.tnn_mul(sess, tw.tap_blk, delta), dmv * tv)
