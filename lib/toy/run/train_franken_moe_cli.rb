      ...
      module TrainFrankenMoe
        ...
        def self.run_cli
          ...
          if top1 && n_layers > 1 && !bp_spine
            puts "toy-train-franken-moe: --routing top1 at --shape deep needs --moe-policy bp-spine. At L>1 the router's credit path reaches back through an earlier layer's mul_mat_id, which has NO ggml backward (toy#110); bp-spine's detach cut is what keeps the experts off that path."
            return 1
          end
