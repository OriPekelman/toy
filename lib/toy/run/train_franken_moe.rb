    ...
    module Run
      module TrainFrankenMoe
        def self.run
          ...
          forward_tower(sess, tow_a, t_tok, t_labels, [sel1, sel2], eye, false, 0, TinyNN.tnn_null_ptr)
          forward_tower(sess, tow_b, t_tok, t_labels, [sel1, sel2], eye, top1, 0, TinyNN.tnn_null_ptr)
