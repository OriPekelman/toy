...
class LlamaSeqForwardFFICacheMetal
  ...
  def lora_name_q!(t_a, t_b, head_prefix)
    TinyNNMetal.tnn_tensor_set_name(t_a, head_prefix + ".lora_a.weight")
    TinyNNMetal.tnn_tensor_set_name(t_b, head_prefix + ".lora_b.weight")
  end

  def lora_name_q_adam!(t_a_m, t_a_v, t_b_m, t_b_v, head_prefix)
    TinyNNMetal.tnn_tensor_set_name(t_a_m, head_prefix + ".lora_a.m")
    TinyNNMetal.tnn_tensor_set_name(t_a_v, head_prefix + ".lora_a.v")
    TinyNNMetal.tnn_tensor_set_name(t_b_m, head_prefix + ".lora_b.m")
    TinyNNMetal.tnn_tensor_set_name(t_b_v, head_prefix + ".lora_b.v")
  end
