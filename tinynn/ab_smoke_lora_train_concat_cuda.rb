...
t_out    = TinyNNCuda.tnn_matmul(sess, t_W_o, t_concat)
t_o_sq   = TinyNNCuda.tnn_mul(sess, t_out, t_out)
...
t_grad_A0 = TinyNNCuda.tnn_tensor_grad(sess, t_A0)
t_grad_B0 = TinyNNCuda.tnn_tensor_grad(sess, t_B0)
t_grad_A1 = TinyNNCuda.tnn_tensor_grad(sess, t_A1)
t_grad_B1 = TinyNNCuda.tnn_tensor_grad(sess, t_B1)
t_opt_A0  = TinyNNCuda.tnn_opt_step_sgd(sess, t_A0, t_grad_A0, t_hp)
t_opt_B0  = TinyNNCuda.tnn_opt_step_sgd(sess, t_B0, t_grad_B0, t_hp)
t_opt_A1  = TinyNNCuda.tnn_opt_step_sgd(sess, t_A1, t_grad_A1, t_hp)
t_opt_B1  = TinyNNCuda.tnn_opt_step_sgd(sess, t_B1, t_grad_B1, t_hp)
TinyNNCuda.tnn_extend_backward_graph(sess, t_opt_A0)
TinyNNCuda.tnn_extend_backward_graph(sess, t_opt_B0)
TinyNNCuda.tnn_extend_backward_graph(sess, t_opt_A1)
TinyNNCuda.tnn_extend_backward_graph(sess, t_opt_B1)
