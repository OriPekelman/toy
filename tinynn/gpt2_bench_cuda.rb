...
require_relative "../lib/toy/llm/engine/gpt2_fwd_engine_cuda"
...
ffi_full_cache_cuda.realize_for(T_SEQ, cfg.d_model, cfg.d_ff,
...
kv_cuda.realize_for(MAX_T, cfg.d_model, cfg.d_ff,
                cfg.n_heads, cfg.n_layers, cfg.vocab_size,
                cfg.context_length)
