...
libexec:
	mkdir -p libexec
libexec/toy-infer: lib/toy/run/infer.rb lib/arch.rb lib/transformer_lm.rb lib/toy_smollm2_ffi_kv.rb lib/toy_smollm2_loader.rb lib/transformer.rb lib/gpt2.rb lib/gguf_load.rb lib/tinynn.rb lib/tokenizer.rb tinynn/libtinynn_ggml.a | libexec
	$(SPINEL) $< -o $@
