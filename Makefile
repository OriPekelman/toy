...
libexec/toy-eval-lmc: lib/toy/run/eval_lmc.rb lib/toy/llm/engine/llama_seq_engine.rb lib/toy/models/toy_smollm2.rb lib/toy.rb lib/toy/models/transformer.rb lib/toy/train/toy_drift_grad.rb lib/tinynn.rb tinynn/libtinynn_ggml.a | libexec
	$(SPINEL) $< -o $@
...
libexec/toy-train-lora: lib/toy/run/train_lora.rb lib/toy.rb lib/toy/models/toy_smollm2.rb \
