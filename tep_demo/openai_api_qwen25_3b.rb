# tep_demo/openai_api_qwen25_3b.rb -- OpenAI-compatible API backed by
...
puts "[openai_api_qwen25_3b] loading config from " + GGUF_PATH
STATE.cfg = SmolLM2ConfigLoader.read(GGUF_PATH)
puts "[openai_api_qwen25_3b] vocab=" + STATE.cfg.vocab.to_s +
