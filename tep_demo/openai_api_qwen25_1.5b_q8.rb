# tep_demo/openai_api_qwen25_1.5b_q8.rb -- OpenAI-compatible API backed by
...
GGUF_PATH  = "data/qwen25-1.5b-native-q8.gguf"
...
puts "[openai_api_qwen25_1.5b_q8] loading config from " + GGUF_PATH
STATE.cfg = SmolLM2ConfigLoader.read(GGUF_PATH)
puts "[openai_api_qwen25_1.5b_q8] vocab=" + STATE.cfg.vocab.to_s +
...
puts "[openai_api_qwen25_1.5b_q8] flags: untied=" + flags.untied.to_s +
