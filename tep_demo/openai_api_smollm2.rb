# tep_demo/openai_api_smollm2.rb -- OpenAI-compatible API backed by
...
puts "[openai_api_smollm2] loading config from " + GGUF_PATH
STATE.cfg = SmolLM2ConfigLoader.read(GGUF_PATH)
puts "[openai_api_smollm2] vocab=" + STATE.cfg.vocab.to_s +
...
puts "[openai_api_smollm2] flags: untied=" + flags.untied.to_s +
