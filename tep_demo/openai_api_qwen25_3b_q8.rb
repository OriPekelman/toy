# tep_demo/openai_api_qwen25_3b_q8.rb -- OpenAI-compatible API backed by
...
GGUF_PATH  = "data/qwen25-3b-native-q8.gguf"
MODEL_NAME = "qwen25-3b-q8"
MAX_T      = 256
...
puts "[openai_api_qwen25_3b_q8] loading config from " + GGUF_PATH
STATE.cfg = SmolLM2ConfigLoader.read(GGUF_PATH)
puts "[openai_api_qwen25_3b_q8] vocab=" + STATE.cfg.vocab.to_s +
...
puts "[openai_api_qwen25_3b_q8] flags: untied=" + flags.untied.to_s +
